...
CNSIC_ROOT="/home/kozz36/cnsic-agent-init-validation"
GENTLE_ROOT="/home/kozz36/gentle-ai-upstream-986-review"
PRIMARY_ROOT="/home/kozz36/cnsic-agent-init-primary-experiment-20260730"
ENRICHED_ROOT="/home/kozz36/cnsic-agent-init-primary-experiment-v2-20260731"
COMPILER_ROOT="/home/kozz36/cnsic-agent-init-primary-experiment-v3-20260731"
...
valid_comparison() {
  ...
  grep -Fq '/home/kozz36/cnsic-agent-init-validation/openspec/config.yaml' "$comparison" || return 1
...
if valid_task_baseline /home/kozz36/cnsic-agent-init-primary-experiment-v4-20260731 "$TASK_OUTPUT" "$TASK_COMPARISON" "$TASK_REPORT"; then
