...
The orchestrator consumes the producer-resolved rubric envelope ONCE per session (at first apply/verify launch) and caches it, re-classifying each apply slice by its diff signature.
<!-- /shape:cache-sentence -->
